 ...
 * @author piotrhol
 * 
 *         Terms: - real path - file path of an empty folder, i.e. /results/series1/ - dLibra path - file path of a file
 *         representing an empty folder, i.e. /results/series1.emptyfolder
 */
public class EmptyFoldersUtility {
    ...
    /**
     * Checks if supplied file path represents an empty folder in dLibra. Checks file path syntax only, without
     * connecting to dLibra.
     * 
     * @param filePath
     *            File path, i.e. /results/series1.emptyfolder
    ...
    public static String convertDlibra2Real(String filePath) {
        ...
        return filePath.substring(0, filePath.indexOf(dLibraPathSuffix)).concat("/");
    }
