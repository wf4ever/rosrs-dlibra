...
public class EditionHelper {
     ...
     * @throws DLibraException
     */
    public EditionId getLastEditionId(String groupPublicationName, String publicationName)
            throws RemoteException, DLibraException {
    ...
    public Edition getLastEdition(String groupPublicationName, String publicationName)
            throws RemoteException, DLibraException {
        PublicationId publicationId = dLibra.getPublicationsHelper().getPublicationId(groupPublicationName,
            publicationName);
    ...
    /**
     * Creates an edition for a given publication, copying all files associated with most recently created edition for
     * this publication.
     * 
     * @param editionName
     * @param groupPublicationName
